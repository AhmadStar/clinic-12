<?php
  ...
  echo anchor('patient/register','<span class="medical-icon-i-registration" aria-hidden="true"></span> <br/>'.tr('RegisterPatient'),array("class"=>"btn btn-info btn-lg", "role"=>"button","title"=>tr('Registernewpatient')));
