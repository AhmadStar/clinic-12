<div class="row">
  <div class="col col-md-8 well well-sm">
    <?php echo form_open('diagnose/new_diagnose',array("id"=>"newDiagnoseForm", "role"=>"form",)); ?>
      <fieldset>
        <legend>- <?php trP('DiagnoseInformation')?>:</legend>        
        <div>
      ...
      <fieldset>
        <legend>- <?php trP('Description')?>: </legend>
        <div>
          <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-md-6"><?php echo anchor('diagnose',tr('cancel'),array('class'=>'form-control btn btn-info'));?></div>
      </div>
    <?php echo form_close(); ?>
  </div>
</div>
