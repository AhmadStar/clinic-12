        ...
        <div class="panel-body">
            <form id="form-filter" class="form-horizontal filter-body">
                ...
                <div class="form-group">
                    ...
                    <label for="LastName" class="col-sm-2 control-label">
                        <?php trP('CreatedDate')?></label>
                    <div class="input-group date col-md-4">
                        <input type="text" data-date-format="yyyy-mm-dd" autocomplete="off" id="created_date" class="form-control" placeholder="انقر لتدخل التاريخ" />
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-12">
                        <button type="button" id="btn-filter" class="btn btn-primary">
                            <?php trP('Filter')?></button>
                        <button type="button" id="btn-reset" class="btn btn-default">
                            <?php trP('Reset')?></button>
                    </div>
                </div>
            </form>
        </div>
