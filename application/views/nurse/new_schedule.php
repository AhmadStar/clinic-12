        ...
        <fieldset>
            ...
            <div>
                ...
                <div class="form-group">
                    <div class="form-group">
                        <div class="col-md-6"><?php echo form_dropdown('nurse_id',$nurse_list,$this->input->post('nurse_id'),"class='form-control' title='Nurse' required");?></div>
                    </div>                    
                    <div class="form-group">
                        <div class="col-md-6"><input type="Date" name='work_date' id='work_date' value="<?php echo $this->input->post('work_date');?>" class='form-control' placeholder='<?php trP('WorkDate')?>' title='work_date' required /></div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="form-group">
