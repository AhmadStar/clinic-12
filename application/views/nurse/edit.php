    ...
    <div class="col col-md-8 well well-sm">
        ...
        <fieldset>
            ...
            <div>
                ...
                <div class="form-group">
                    <div class="col-md-6"><input type="phone" name='phone' id='phone' value="<?php echo set_value('phone', $nurse[0]['phone']);?>" class='form-control' placeholder="<?php trP('phone')?>" title='phone' required /></div>
