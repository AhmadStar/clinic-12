<div class="row">
  <div class="col col-md-8 well well-sm">
    <?php echo form_open('drug/add_drug',array("id"=>"addDrugForm", "role"=>"form",)); ?>
      <fieldset>
        <legend>- <?php trp('PurchasedDrugInformation')?>:</legend>
        <div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6"><input type="number" name='purchase_price' id='purchase_price' value="<?php echo $this->input->post('purchase_price');?>" class='form-control' placeholder="<?php trP('UnitPrice')?>" title='Unit Price' required /></div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6"><input type="date" name='purchase_date' id='purchase_date' value="<?php echo set_value('purchase_date',@$today);?>" class='form-control' placeholder="<?php trP('PurchaseDate')?>" title='Purchase Date' required /></div>
          </div>
      </fieldset>
      <fieldset>
