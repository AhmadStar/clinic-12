            ...
            <div class="form-group">
                <div class="col-md-9">
                    ...
                    <div class="col-md-12" style="margin-bottom:10px;">
                        <label class="radio-inline"><input type="radio" name='gender' value="1" title='Male' <?php echo isset($_POST['gender'])?($this->input->post('gender')?'checked':''):($patient->gender?'checked':'');?> />
                            <?php trP('Male')?></label>
                        <label class="radio-inline"><input type="radio" name='gender' value="0" title='Female' <?php echo isset($_POST['gender'])?($this->input->post('gender')?'':'checked'):($patient->gender?'':'checked');?> />
...
<div class="pull-right" title="Go to Patients">

    <?php echo anchor('nurse', '<button class="btn btn-return"><span>العودة إلى قائمة المرضى </span></button>');?>
</div>
<?php 
}else{
